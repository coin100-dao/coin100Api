...
describe('Coin API Routes', () => {
    describe('GET /api/coins', () => {
        it('should return coin data for the last 5 minutes by default', async () => {
    ...
    describe('GET /api/coins/symbol/:symbol', () => {
        ...
        it('should return most recent data when no data in date range', async () => {
            const symbol = 'btc';
            ...
            expect(response.body.data[0].symbol.toLowerCase()).toBe(symbol);
        });
        ...
        it('should return 404 for non-existent coin symbol', async () => {
            ...
            expect(response.body).toHaveProperty('success', false);
            expect(response.body.error).toBe('No data found for the specified coin');
        });
    });
